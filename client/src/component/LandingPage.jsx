                ...
                <div style={{ display: "flex", flexDirection: "row",  width: "55vw", height:"65vh", alignItems:"center", justifyContent:"center", backgroundColor:"white" }}>
                    ...
                    <Card style={{width:"95%", borderStyle: "none",height:"100%"}} className="text-center">
                        <Card.Body style={{ backgroundColor: '#000133', color: 'white', fontWeight: "bold"}}>
                            <Card.Text style={{ fontSize: '28px', color: "white", fontFamily: "Bungee Hairline" }}>
                                B3 is a safety app that allows users to share their location with
                                friends and family. They can also send their location and SMS
                                messages to their emergency contacts by using a custom phrase.
                             </Card.Text>
                            <Link to={'/login'}>
